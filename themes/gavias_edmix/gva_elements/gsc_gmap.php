...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_edmix')) ?>/vendor/gmap3.js"></script>
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'gavias_edmix')) ?>/vendor/jquery.ui.map.min.js"></script>
